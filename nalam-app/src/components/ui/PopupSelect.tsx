  ...
  return (
    <div ref={rootRef} className="relative">
      <button
        ...
        className={`flex min-h-[46px] w-full items-center justify-between gap-2 rounded-xl border bg-[rgba(10,30,23,0.85)] px-3.5 py-2.5 text-left text-sm text-[#F4FFF9] shadow-sm transition-colors focus-visible:outline-none focus-visible:ring-[3px] focus-visible:ring-teal-400/[0.08] ${
          hasError
            ? "border-signal-coral/60"
            : open
              ? "border-teal-400"
              : "border-[rgba(150,220,190,0.20)]"
        }`}
      >
        ...
        <svg
          ...
          fill="none"
          aria-hidden
          className={`shrink-0 text-mist-100/60 transition-transform duration-150 ${open ? "rotate-180" : ""}`}
        >
      ...
      <AnimatePresence>
        {open ? (
          <motion.ul
            ...
            className="absolute left-0 top-[calc(100%+6px)] z-20 max-h-56 w-full overflow-y-auto rounded-xl border border-[rgba(57,255,136,0.25)] bg-[#0D1D18] p-1.5 shadow-[0_16px_40px_rgba(0,0,0,0.35)] focus-visible:outline-none"
          >
